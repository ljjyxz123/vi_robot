...
void depthCallback(const sensor_msgs::Image::ConstPtr& msg)
{
	...
	IplImage *depthImg = cvCreateImage(cvSize(640, 480), IPL_DEPTH_8U, 3);
	try
	{
		cvImgPtr = cv_bridge::toCvCopy(msg, sensor_msgs::image_encodings::TYPE_8UC3);
...
int main(int argc, char **argv)
{
	...
	ros::Subscriber RgbRawSub = node.subscribe("/camera/rgb/image_raw", 100, depthCallback);
